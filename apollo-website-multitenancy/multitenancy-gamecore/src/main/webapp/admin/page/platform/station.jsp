...
<body>
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post">
			...
			<div class="fitem">
				<label>站点名称:</label> <input name="name" class="easyui-textbox"
					style="width: 250px;" data-options="required:true" />
			</div>

			<div class="fitem">
				<label>别名:</label> <input name="floder" class="easyui-textbox"
					style="width: 250px;" data-options="required:true">
			</div>

			<div class="fitem">
				<label>大大股东:</label> <input name="ddgd" class="easyui-textbox"
					style="width: 250px;" data-options="required:true">
			</div>
...
<script language="javascript">
	...
	function saveStation() {
		...
		var url = '${base}/admin/station/save.do';
	...
	$('#dg').datagrid({
		...
		/* {field:'db',title:'开起时间',width:30},
		{field:'timeout',title:'关闭时间',width:50}, */
		{
			field : 'createTime',
			title : '创建时间',
			width : 150,
