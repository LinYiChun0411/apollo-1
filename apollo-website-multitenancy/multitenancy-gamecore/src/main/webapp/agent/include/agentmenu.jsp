	...
	<div class="container">
		<div id="navbar" class="navbar-collapse collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#">在线 <span class="badge">{{onlineUser}}</span> 人</a></li>
				<li><a href="#">充值 <span class="badge">{{depositCount}}</span> 笔</a></li>
				<li><a href="#">提款 <span class="badge">{{withdrawCount}}</span> 笔</a></li>
...
<script type="text/javascript">
	$(function() {
		...
		$.ajax({
			...
			success : function(data) {
				...
				$("#agentheadmenu").html(html + menuHtml);
	...
	function doLogout() {
		window.location.href = "${base}/agent/logout.do";
	}
</script>
